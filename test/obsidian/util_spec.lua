...
describe("obsidian.util", function()
  ...
  it("should correctly determine if a string contains a substring", function()
    assert.is_true(util.str_contains("Foobar", "Foo"))
    assert.is_true(util.str_contains("Foobar", "foo", true))
    assert.is_false(util.str_contains("Foobar", "foo"))
  end)
end)
