...
describe("util.is_upper()", function()
  it("should recognize uppercase letters and words", function()
    assert.is_true(util.is_upper "A")
    assert.is_false(util.is_upper "a")
  end)
end)

describe("util.to_snake_case()", function()
  it("should transform camel case into snake case", function()
    assert.are_equal(util.to_snake_case "CamelCase", "camel_case")
    assert.are_equal(util.to_snake_case "ObsidianTOC", "obsidian_toc")
    assert.are_equal(util.to_snake_case "ObsidianExtractNote", "obsidian_extract_note")
  end)

  it("should keep snake case as-is", function()
    assert.are_equal(util.to_snake_case "snake_case", "snake_case")
  end)
end)
