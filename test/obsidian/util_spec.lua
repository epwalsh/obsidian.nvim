...
describe("util.is_parent_of()", function()
  it("should identify parent directories correctly", function()
    assert.is_true(util.is_parent_of("~/Foo/Bar", "~/Foo/Bar/baz.md"))
    assert.is_false(util.is_parent_of("~/Foo/Bar", "~/Foo/Bar.md"))
  end)
end)
